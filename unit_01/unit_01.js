...
document.querySelector('.three').innerHTML = '<h3>Да я же программист!))</h3>';
...
document.querySelector('.four').innerHTML += '<h4>Я точно программист!</h4> <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque iste labore libero repellat suscipit totam vitae voluptate. Fugiat, numquam unde!</p>'
