...
let ar3 =  ['hello', 23, true, 'hello', 23, true]
...
function f16() {
    ...
    document.querySelector('.out-16-odd').innerHTML = getOut(ar16_odd);
    document.querySelector('.out-16-even').innerHTML = getOut(ar16_even);
    ar16_odd = [];
    ar16_even = [];
}
...
function f17() {
    ...
    document.querySelector('.out-17').innerHTML = sum
