...
function f11() {
    ...
    document.querySelector('.out-11').innerHTML = d11.indexOf(+input.value)
}
...
function f14() {
    const input = +document.querySelector('.i-14').value
    a = input
    for (let i = 0; i < a; i++) {
        d14 += 1
    }
...
function f19() {
    ...
    document.querySelector('.out-19').textContent = s
}
