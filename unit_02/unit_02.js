...
function t10() {
    ...
    document.querySelector('.out-10').textContent = input * 10;
}
...
function t11() {
    ...
    document.querySelector('.out-11').textContent = +input + 10;
}
...
function t12() {
    const name = document.querySelector('.i-12_1').value;
    const surname = document.querySelector('.i-12_2').value;
...
function t13() {
    const a = +(document.querySelector('.i-13_1').value);
    const b = +(document.querySelector('.i-13_2').value);
...
function t19() {
    ...
    document.querySelector('.out-19').textContent = parseInt(a) + parseInt(b);
}
...
function t20() {
    const name = document.querySelector('.i-20-1').value;
    const surname = document.querySelector('.i-20-2').value;
    const age = document.querySelector('.i-20-3').value;
    const prof = document.querySelector('.i-20-4').value;

    document.querySelector('.out-20').textContent = 'Уважаемый '+ name + ', '+ surname + ', ваш возраст ' + age +' года, по професси вы ' + prof;
}
