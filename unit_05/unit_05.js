...
function t7() {
    const value = document.querySelector('.i-7').value;
    let out = '';
    for (i = value; i>=0; i--){
        out+=i + ' ';
    }
...
function t8() {
    const v1 = document.querySelector('.i-81').value;
    const v2 = document.querySelector('.i-82').value;
    let out = '';
    for (i=v1; i<=v2; i++ ){
        out+= i + ' '
    }
...
function t9() {
    const v1 = document.querySelector('.i-91').value;
    const v2 = document.querySelector('.i-92').value;
    let out = '';
    if (v2 > v1) {
        for (i=v1; i<=v2; i++ ){
            out+= i + ' '
