...
function f4(){
    ...
    const birthYear = parseInt(document.querySelector('.i-4').value);
...
function f7(){
    const a = +document.querySelector('.i-71').value;
    const b = +document.querySelector('.i-72').value;
    const out = document.querySelector('.out-7');

   out.textContent = Math.pow(a, b);
}
...
function f8(){
    const input = document.querySelector('.s-8').value;
...
function f10(){
    const value = document.querySelector('.s-100').value;
...
function f11(){
    const value = document.querySelector('.s-110').value;
...
function f14(){
    ...
    switch (operation){
        case '+': out.textContent = a + b;
            break;
        case '-': out.textContent = a - b;
            break;
        case '*': out.textContent = a * b;
            break;
        default: out.textContent = a / b;
    }
}
...
function f15(){
    ...
    const select = document.querySelector('.s-153').value;
